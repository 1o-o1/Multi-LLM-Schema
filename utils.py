...
def extract_json_from_text(text: str) -> Dict[str, Any]:
    ...
    if json_match:
        ...
        try:
            ...
            # Fix LLM placeholder values that are not valid JSON
            json_str = re.sub(r':\s*__(?=\s*[,}])', ': null', json_str)  # Replace __ with null
            json_str = re.sub(r':\s*__,', ': null,', json_str)  # Handle __ followed by comma
